...
```
    ...
    array[196, 196, 3] f32 n=115248 (0.4 MiB) x∈[-2.118 |▁▅█▇▂▁▁▂▂▁| 2.640] μ=-0.388 σ=1.073
...
```
    ...
    array[3, 196, 196] f32 n=115248 (0.4 MiB) x∈[-2.118 |▂▅█▇▂▁▁▂▂▁| 2.640] μ=-0.388 σ=1.073
...
```
    ...
    array[196, 196, 3] n=115248 (0.9 MiB) x∈[0. |▃▆▆█▂▁▁▁▃▂| 1.000] μ=0.361 σ=0.248
...
```
    ...
    array[2, 2, 2, 196, 196, 3] n=921984 (7.0 MiB) x∈[0. |█▃▃▃▃▃▃▂▂▃| 1.000] μ=0.382 σ=0.319
