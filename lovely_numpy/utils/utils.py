...
# %% auto 0
__all__ = ['sci_mode', 'pretty_str', 'sparse_join', 'ansi_color', 'np_to_str_common', 'history_warning']
...
assert version_info.major == 3 # Python 4 some day?
